...
void main(){
	...
	vec3 vtColour = BPSLM(spotlight1, p, normalize(n)) + BPSLM(spotlight2, p, normalize(n)) + BPSLM(spotlight3, p, normalize(n)) + BPSLM(spotlight4, p, normalize(n)) + BPSLM(spotlight5, p, normalize(n));
