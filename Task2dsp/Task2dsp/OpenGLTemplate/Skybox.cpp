...
{
	//Skyboxes has been sourced from: https://opengameart.org/content/space-skyboxes-0 and adjusted in Gimp to fit the needs of this coursework.
	//Imports skybox and sets it up. Skybox had to be adjusted to fit perfectly. 
	m_cubemapTexture.Create("resources\\skyboxes\\right.png", "resources\\skyboxes\\left.png", "resources\\skyboxes\\top.jpg", "resources\\skyboxes\\bottom.jpg", "resources\\skyboxes\\back.png", "resources\\skyboxes\\front.png");
	...
	{
		// Right face - Previous Front
		glm::vec3(size, size, size), glm::vec3(size, -size, size), glm::vec3(-size, size, size), glm::vec3(-size, -size, size),
		// Left face - Previous Back
		glm::vec3(-size, size, -size), glm::vec3(-size, -size, -size), glm::vec3(size, size, -size), glm::vec3(size, -size, -size),
		// Top face - Previous Left
		glm::vec3(-size, size, size), glm::vec3(-size, -size, size), glm::vec3(-size, size, -size), glm::vec3(-size, -size, -size),
		// Bottom face - Previous Right
		glm::vec3(size, size, -size), glm::vec3(size, -size, -size), glm::vec3(size, size, size), glm::vec3(size, -size, size),
		// Back face - Previous Top
		glm::vec3(-size, size, -size), glm::vec3(size, size, -size), glm::vec3(-size, size, size), glm::vec3(size, size, size),
		// Front face - Previous Bottom
		glm::vec3(size, -size, -size), glm::vec3(-size, -size, -size), glm::vec3(size, -size, size), glm::vec3(-size, -size, size),
	};
